...
function Dashboard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-5xl font-bold text-foreground mb-4", children: "NullDraft" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground", children: "Turn instructions into step-by-step screenshot documentation" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center gap-4 mb-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          ...
          className: "h-12 px-6",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FolderOpen, { className: "mr-2 h-5 w-5" }),
            "Open Existing"
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          ...
          className: "h-12 px-6",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Settings$1, { className: "mr-2 h-5 w-5" }),
            "Settings"
          ]
        }
      )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Card,
          {
            className: `glass border-2 border-dashed transition-all cursor-pointer ${isDragging ? "border-primary bg-primary/5 scale-105" : "border-muted-foreground/25 hover:border-primary/50"}`,
            onDragOver: handleDragOver,
            onDragLeave: handleDragLeave,
            onDrop: handleDrop,
            onClick: handleFileSelect,
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-16 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                animate: { y: isDragging ? -5 : 0 },
                transition: { duration: 0.2 },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "h-16 w-16 mx-auto mb-4 text-muted-foreground" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-semibold mb-2", children: "Drop your instruction file here" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-4", children: "or click to browse" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center gap-2 text-sm text-muted-foreground", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 py-1 bg-muted rounded", children: ".pdf" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 py-1 bg-muted rounded", children: ".docx" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 py-1 bg-muted rounded", children: ".txt" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 py-1 bg-muted rounded", children: ".tex" })
                  ] })
                ]
              }
            ) })
    ...
    mockRecentProjects.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold mb-6", children: "Recent Projects" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4", children: mockRecentProjects.map((project) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          className: "cursor-pointer hover:shadow-lg transition-shadow",
          onClick: () => navigate("/review"),
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-lg", children: project.name }),
...
function StepItem({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "mb-3 transition-all hover:shadow-md", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-3", children: caption }),
...
function Review() {
  const navigate = useNavigate();
  const [steps2, setSteps] = reactExports.useState(mockSteps);
  const totalSteps = steps2.length;
  const checkedSteps = steps2.filter((s) => s.checked).length;
  const screenshotCount = steps2.filter((s) => !s.skipped).length;
  const handleToggleStep = (stepId, checked) => {
    setSteps(
      (prev) => prev.map(
        (step) => step.id === stepId ? { ...step, checked } : step
      )
    );
  };
  ...
  const handleSkip = (stepId) => {
    setSteps(
      (prev) => prev.map(
        (step) => step.id === stepId ? { ...step, skipped: !step.skipped } : step
      )
    );
  };
  ...
  const handleStartCapture = () => {
    if (typeof window !== "undefined" && window.electronAPI) {
      ...
      const firstStep = steps2.find((s) => !s.skipped && !s.checked);
      if (firstStep) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold", children: "Review Steps" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass rounded-xl p-6 mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "secondary", className: "text-base px-3 py-1", children: [
        "✓ ",
        checkedSteps,
        " steps completed"
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { orientation: "vertical", className: "h-8" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "secondary", className: "text-base px-3 py-1", children: [
        "📸 ",
        screenshotCount,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { orientation: "vertical", className: "h-8" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "default", className: "text-base px-3 py-1", children: [
        totalSteps,
        " total steps"
      ] }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "h-[calc(100vh-300px)] pr-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: steps2.map((step) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      StepItem,
      {
...
function Capture() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold", children: "Capture Mode" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "glass mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "h-5 w-5" }),
          "Capture in Progress"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Use the floating HUD overlay to capture screenshots for each step" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
          ...
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("kbd", { className: "px-2 py-1 bg-muted rounded text-xs", children: "Ctrl+Shift+S" }),
          " ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Instructions" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "The floating HUD will guide you through each step" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "•" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: 'Click "Capture" in the HUD or press Ctrl+Shift+S to take a screenshot' })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "•" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "You can skip steps that don't require screenshots" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "•" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: `Click "Finish" when you're done capturing all screenshots` })
        ] })
      ] }) })
    ] })
  ] }) });
...
const formatOptions = [
  { value: "docx", label: "DOCX", icon: FileText, description: "Microsoft Word document" },
  { value: "tex", label: "LaTeX", icon: FileCode, description: "LaTeX source file" },
  { value: "md", label: "Markdown", icon: FileType, description: "Markdown file" },
...
function Export() {
  ...
  const [fileName, setFileName] = reactExports.useState("documentation");
  const [selectedTemplate, setSelectedTemplate] = reactExports.useState("default");
  const handleExport = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold", children: "Generate Document" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20" }),
      " "
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "glass mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Export Format" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Choose the format for your documentation" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { value: selectedFormat, onValueChange: (v2) => setSelectedFormat(v2), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsList, { className: "grid w-full grid-cols-4", children: formatOptions.map((option) => {
          const Icon = option.icon;
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: option.value, className: "flex flex-col gap-2 h-auto py-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-5 w-5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: option.label })
          ] }, option.value);
        }) }),
        formatOptions.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: option.value, className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground", children: option.description }) }, option.value))
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "glass mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "File Name" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "fileName", children: "Output file name" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
          "Preview: ",
          /* @__PURE__ */ jsxRuntimeExports.jsxs("code", { className: "bg-muted px-1 rounded", children: [
            fileName,
            ".",
            selectedFormat
          ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "glass mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Template" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Select a template for your document" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "template", children: "Document template" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            id: "template",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "default", children: "Default Template" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "academic", children: "Academic" })
            ]
          }
        )
      ] }) })
...
function Settings() {
  ...
  const [captureHotkey, setCaptureHotkey] = reactExports.useState("Ctrl+Shift+S");
  const [skipHotkey, setSkipHotkey] = reactExports.useState("Ctrl+Shift+N");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "glass mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Configure your API key for AI processing" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Your API key is stored locally and never shared" })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "glass mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Keyboard, { className: "h-5 w-5" }),
          "Keyboard Shortcuts"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Customize keyboard shortcuts for capture actions" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "captureHotkey", children: "Capture Screenshot" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              id: "captureHotkey",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Click to customize (coming soon)" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "skipHotkey", children: "Skip Step" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              id: "skipHotkey",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "glass mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Customize the application appearance" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-0.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Switch to dark theme" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Switch,
          {
...
function FloatingHUD() {
  ...
  reactExports.useEffect(() => {
    if (typeof window !== "undefined" && window.electronAPI) {
      window.electronAPI.onHUDDataUpdate((data) => {
        setHudData(data);
      });
      return () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 flex items-center  justify-center pointer-events-none p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "glass-dark w-96 pointer-events-auto shadow-xl rounded-2xl border-white/20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3 cursor-move", style: { WebkitAppRegion: "drag" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-sm font-medium text-white/90", children: [
        "Step ",
        hudData.currentStep,
        " of ",
        hudData.totalSteps
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 w-2 rounded-full bg-green-500 animate-pulse" }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", style: { WebkitAppRegion: "no-drag" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold text-white", children: hudData.stepTitle }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/70 leading-relaxed", children: hudData.stepDescription })
      ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SkipForward, { className: "h-4 w-4 mr-2" }),
                "Skip"
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-white/50 text-center mt-3", children: [
          "Press ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("kbd", { className: "px-1.5 py-0.5 bg-white/10 rounded text-xs", children: "Ctrl+Shift+S" }),
          " to capture"
        ] })
      ] })
    ] })
...
function App() {
  ...
  if (isHUDWindow) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingHUD, {});
  }
  const handleClose = () => {
    if (typeof window !== "undefined") {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen relative bg-gray-900/20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-4 right-4 z-50 flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          variant: "ghost",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/review", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Review, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/capture", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Capture, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/export", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Export, {}) }),
